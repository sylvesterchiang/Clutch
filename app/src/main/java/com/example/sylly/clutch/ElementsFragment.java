...
public class ElementsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        b3.getBackground().setColorFilter(getActivity().getResources().getColor(R.color.green), PorterDuff.Mode.MULTIPLY);
        b4.getBackground().setColorFilter(Color.BLACK, PorterDuff.Mode.MULTIPLY);
